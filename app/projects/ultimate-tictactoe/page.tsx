    ...
    return (
        <div>
            ...
            <div className="container mx-auto p-4">
                <h1 className="text-4xl font-bold mb-4">Ultimate TicTacToe</h1>
                
                <div className="mb-4 p-4 border rounded-lg shadow-md">
                    <p>
                        This is a mobile application that allows users to play Ultimate TicTacToe. The user can play multiplayer locally, or online with supabase realtime. The app is built with React Native and uses Firebase as the backend.
                    </p>
                </div>
                {/* <div className="mb-4 p-4 border rounded-lg shadow-md">
