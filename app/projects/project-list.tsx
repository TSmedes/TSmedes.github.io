const items = [
  {
    title: "CapSource",
    summary: "Senior project at SPU. A chrome extension that allows users to submit corrections for video transcripts.",
    thumbnail: "/images/capsource.png",
    details: "/projects/capsource",
  },
  {
    title: "CLI Encryption",
    summary: "Symmetric enxryption algorithm implemented in C++ with a command line interface.",
    thumbnail: "/images/winning_hand.png",
    details: "/projects/encryption",
  },
  {
  ...
  },
  {
    ...
    summary:
      "I developed a website at the request of a customer that explains the steps and process of the learning model they use in their business.",
  ...
  },
  {
    ...
    summary:
      "This is a mock system design plan I made. The project is a mobile application that allows students to budget their finances and log school-related expenses.",
  ...
  },
  {
    title: "TheoNotes",
    summary:
      "A mobile application that allows users to take notes and organize them by category, and subcategory. Designed for storing bible verses and notes on the verses",
  ...
  },
  {
    ...
    summary:
      "An ultimate tic-tac-toe game designed for mobile devices that allows users to play against each other on the same device and online.",
